...
__I/O-bound tasks:__
    ...
    Asynchronous programming is most effective for tasks that involve waiting for external operations,  
    as it allows the program to utilize that waiting time for other tasks. 
